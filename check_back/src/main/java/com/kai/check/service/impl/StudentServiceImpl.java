...
public class StudentServiceImpl extends ServiceImpl<StudentMapper, Student> implements IStudentService {
    ...
    @Override
    @Transactional
    public List<String> listClassStudents(String name) {
        return studentMapper.listClassStudents(name);
    }

    @Override
    public List<ClassDesign> listClassDesigns(String name) {
        return classDesignMapper.listClassDesigns(name);
    }
